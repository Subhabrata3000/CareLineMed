...
PaymentDetailModel paymentDetailModelFromJson(String str) => PaymentDetailModel.fromJson(json.decode(str));

String paymentDetailModelToJson(PaymentDetailModel data) => json.encode(data.toJson());
